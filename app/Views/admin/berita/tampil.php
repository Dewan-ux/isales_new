                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            List Berita Terkini
                            <a href="<?php echo base_url('admin/berita/create'); ?>" class="btn btn-primary float-right">Tambah</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="premi" class="table table-bordered table-hovered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('admin/berita/edit/'.$row['id']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="<?php echo base_url('admin/berita/delete/'.$row['id']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Berita <?php echo $row['judul']?>?');">
