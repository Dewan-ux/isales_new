...
$routes->get('eksport', 'SpajController::eksport', ['namespace' => 'App\Controllers\Spaj']);

$routes->add('callback', 'CallbackControllers::index', ['namespace' => 'App\Controllers\Callback']);
...
$routes->group('produksmile', function($routes)
{
	$routes->add('master/create', 'ProdukPaCarController::mastercreate', ['namespace' => 'App\Controllers\Produk']);
	$routes->add('list', 'ProdukPaCarController::listProduk', ['namespace' => 'App\Controllers\Produk']);
	$routes->add('id', 'ProdukPaCarController::produk', ['namespace' => 'App\Controllers\Produk']);
	$routes->add('update', 'ProdukPaCarController::updateProduk', ['namespace' => 'App\Controllers\Produk']);
	$routes->add('delete', 'ProdukPaCarController::deleteProduk', ['namespace' => 'App\Controllers\Produk']);
	$routes->add('create', 'ProdukPaCarController::create', ['namespace' => 'App\Controllers\Produk']);
});
...
$routes->group('premismile', function($routes)
{
	$routes->add('master/create', 'PremiPaCarController::mastercreate', ['namespace' => 'App\Controllers\Premi']);
	$routes->add('list', 'PremiPaCarController::listPremi', ['namespace' => 'App\Controllers\Premi']);
	$routes->add('id', 'PremiPaCarController::premi', ['namespace' => 'App\Controllers\Premi']);
	$routes->add('update', 'PremiPaCarController::updatePremi', ['namespace' => 'App\Controllers\Premi']);
	$routes->add('delete', 'PremiPaCarController::deletePremi', ['namespace' => 'App\Controllers\Premi']);
	$routes->add('create', 'PremiPaCarController::create', ['namespace' => 'App\Controllers\Premi']);
...
$routes->group('admin', function ($routes) {
	...
	$routes->group('produk', function ($routes) {
		...
		$routes->add('index', 'AdminProductPaCarController::index', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('more', 'AdminProductPaCarController::create', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('ubah/(:num)', 'AdminProductPaCarController::edit/$1', ['namespace' => 'App\Controllers\Admin']);
	});

	$routes->group('produksmile', function($routes){
		$routes->add('index', 'AdminProductPaCarController::index', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('more', 'AdminProductPaCarController::create', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('add', 'AdminProductPaCarController::add', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('ubah/(:num)', 'AdminProductPaCarController::edit/$1', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('update', 'AdminProductPaCarController::update', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('delete/(:num)', 'AdminProductPaCarController::delete/$1', ['namespace' => 'App\Controllers\Admin']);
	});
	...
	$routes->group('performance', function ($routes) {
		...
		$routes->add('export', 'AdminCampaignController::campaign', ['namespace' => 'App\Controllers\Admin']);
	});
	$routes->group('premi', function ($routes) {
		...
		$routes->add('index', 'AdminPremiPaCarController::index', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('more', 'AdminPremiPaCarController::create', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('tambah', 'AdminPremiPaCarController::add', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('ubah/(:num)', 'AdminPremiPaCarController::edit/$1', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('updated', 'AdminPremiPaCarController::update', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('hapus/(:num)', 'AdminPremiPaCarController::delete/$1', ['namespace' => 'App\Controllers\Admin']);
	...
	$routes->group('spaj', function ($routes) {
		...
		$routes->add('preview/(:num)', 'AdminSpajController::preview/$1', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('print/(:num)', 'AdminSpajController::printPdf/$1', ['namespace' => 'App\Controllers\Admin']);
	});
	$routes->group('recording', function ($routes) {
		$routes->add('/', 'AdminRecordingController::index', ['namespace' => 'App\Controllers\Admin']);
		$routes->add('play', 'AdminRecordingController::playRecording', ['namespace' => 'App\Controllers\Admin']);
	});
	$routes->group('campaign', function ($routes) {
		...
		$routes->add('preview/(:num)', 'AdminCampaignController::previewCampaign/$1', ['namespace' => 'App\Controllers\Admin']);
	});
});
...
$routes->group('tsr', function ($routes) {
	$routes->group('order', function ($routes) {
		...
		$routes->add('createPersAc', 'TelesalesController::createOrderPersonalAccient', ['namespace' => 'App\Controllers\Telesales']);
	});
	...
	$routes->add('history/id', 'TelesalesController::historyCall', ['namespace' => 'App\Controllers\Telesales']);
	$routes->add('call/start', 'TelesalesController::startCall', ['namespace' => 'App\Controllers\Telesales']);
	$routes->add('ci/call/start', 'TelesalesController::startConfirmInterestCall', ['namespace' => 'App\Controllers\Telesales']);
	$routes->add('call/end', 'TelesalesController::endCall', ['namespace' => 'App\Controllers\Telesales']);
	$routes->add('ci/call/end', 'TelesalesController::endConfirmInterestCall', ['namespace' => 'App\Controllers\Telesales']);
...
$routes->group('qa', function ($routes) {
	$routes->group('order', function ($routes) {
		...
		$routes->add('update', 'QaController::updateOrder', ['namespace' => 'App\Controllers\Qa']);
	});
});
...
$routes->group('services', function ($routes) {
	...
	$routes->add('download/recording', 'ServicesController::downloadRecording', ['namespace' => 'App\Controllers\Services']);
	$routes->add('forceout', 'ServicesController::forceLout', ['namespace' => 'App\Controllers\Services']);
	$routes->add('cronjob/downrec', 'ServicesController::cjDownRecording', ['namespace' => 'App\Controllers\Services']);
	$routes->add('media', 'ServicesController::streaming', ['namespace' => 'App\Controllers\Services']);
});

$routes->group('servicesadmin', function ($routes) {
	$routes->add('resetshare', 'ServicesAdminController::reset', ['namespace' => 'App\Controllers\ServicesAdmin']);
	$routes->add('get/recording', 'ServicesAdminController::getRecording', ['namespace' => 'App\Controllers\ServicesAdmin']);
	$routes->add('all', 'ServicesAdminController::allRecording', ['namespace' => 'App\Controllers\ServicesAdmin']);
	// $routes->add('list', 'ServicesAdminController::listRecording', ['namespace' => 'App\Controllers\ServicesAdmin']);
	$routes->add('list', 'ServicesController::donloadZipRecording', ['namespace' => 'App\Controllers\ServicesAdmin']);
});
...
$routes->group('spaj', function ($routes) {
	$routes->add('list', 'SpajController::listSpaj', ['namespace' => 'App\Controllers\Spaj']);
	$routes->add('id', 'SpajController::detailSpaj', ['namespace' => 'App\Controllers\Spaj']);
});
...
$routes->group('campaign', function ($routes) {
	...
	$routes->add('detail', 'CampaignController::detailCampaign', ['namespace' => 'App\Controllers\Campaign']);
});
/**
 * --------------------------------------------------------------------
 * Additional Routing
